        ...
        <div className="row">
          {recipes.map((recipe) => (
            <div className="col" key={recipe.id}>
                <div className="text-overlay" style={{color:"#297eba"}}><h1>{recipe.title}</h1></div>
              <img
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    <li class="breadcrumb-item">
                      <Link to="/" style={{color:"#8f1367"}}>Yemek</Link>
                    </li>
                    <li className="breadcrumb-item">
                      <Link to="/kategori" style={{color:"#8fb939"}}>Kategori</Link>
                    </li>
                    <li className="breadcrumb-item">
                      <Link to="#" style={{color:"#ffc107"}}>{categories.find((category) => category.id === recipe.categoryId)?.name}</Link>
                    </li>
                  </ol>
                </nav>
              </div>
